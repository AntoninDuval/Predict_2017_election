...
candidates_list_1rst_turn = ['HAMON', 'DUPONT-AIGNAN', 'LASSALLE', 'ARTHAUD', 'POUTOU', \
...
def regression_plot(true_train, true_test, list_of_pred_df, candidat, town_train_index, town_test_index, turn=1,save=False, plot_name=None):
    ...
    for j, pred in enumerate(list_of_pred_df):
        ...
        plot_df_train.replace(cat_values, inplace=True)
        ...
        plot_df_test.replace(cat_values, inplace=True)
